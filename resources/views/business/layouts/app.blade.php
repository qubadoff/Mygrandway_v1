...
<div class="page">
    @include('business.layouts.inc.header')
    @yield('content')
    <div class="page-wrapper">
        @include('business.layouts.inc.footer')
    </div>
</div>
<!-- Libs JS -->
<script src="{{ url('/') }}/business/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
<script src="{{ url('/') }}/business/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062" defer></script>
<script src="{{ url('/') }}/business/dist/libs/jsvectormap/dist/maps/world.js?1684106062" defer></script>
<script src="{{ url('/') }}/business/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062" defer></script>
<!-- Tabler Core -->
