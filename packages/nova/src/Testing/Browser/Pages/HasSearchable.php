...
trait HasSearchable
{
    ...
    {
        $browser->within(new SearchInputComponent($attribute), function ($browser) use ($search) {
    ...
    {
        $browser->within(new SearchInputComponent($attribute), function ($browser) {
    ...
    {
        $browser->within(new SearchInputComponent($attribute), function ($browser) use ($resultIndex) {
    ...
    {
        $browser->within(new SearchInputComponent($attribute), function ($browser) use ($search, $resultIndex) {
    ...
    {
        $browser->within(new SearchInputComponent($attribute), function ($browser) use ($fieldCallback) {
